...
const STATUS_OPTIONS = [
  { value: "new", label: "Mới", color: "bg-gray-100 text-gray-700 hover:bg-gray-200", activeColor: "bg-gray-800 text-white" },
  { value: "contacting", label: "Đang liên hệ", color: "bg-blue-50 text-blue-700 hover:bg-blue-100", activeColor: "bg-blue-600 text-white" },
  { value: "potential", label: "Tiềm năng", color: "bg-yellow-50 text-yellow-800 hover:bg-yellow-100", activeColor: "bg-yellow-600 text-white" },
  { value: "trial", label: "Dùng thử", color: "bg-purple-50 text-purple-800 hover:bg-purple-100", activeColor: "bg-purple-600 text-white" },
  { value: "closed", label: "Đã chốt", color: "bg-green-50 text-green-800 hover:bg-green-100", activeColor: "bg-green-600 text-white" },
  { value: "lost", label: "Không phù hợp", color: "bg-red-50 text-red-700 hover:bg-red-100", activeColor: "bg-red-600 text-white" },
];
...
export default function Customers() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["customers", search, groupFilter, productFilter, page, statusFilter, fromDate, toDate, sortBy, sortOrder],
          ...
          <thead>
            <tr className="bg-gray-50 text-gray-600 text-xs">
              ...
              <th
                ...
                className="text-left px-4 py-3 font-medium sticky top-0 bg-gray-50 z-20 shadow-[inset_0_-1px_0_rgba(0,0,0,0.1)] cursor-pointer hover:bg-gray-100 select-none"
              >
              ...
              data?.customers.map(c => {
                ...
                return (
                  <tr key={c.id} className={`hover:bg-gray-50 transition-colors ${isSel ? "bg-blue-50" : ""}`}>
                    ...
                    <td className="px-4 py-3 text-gray-500 text-xs">{c.assigned_to?.trim() || "—"}</td>
